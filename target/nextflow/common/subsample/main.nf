  ...
  "resources" : [
    {
      ...
      "path" : "script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/common/subsample/config.vsh.yaml"
    }
  ],
  "description" : "Subsample an anndata file",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test_script.py",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/common_subsample",
    "tag" : "main_build"
  }
}'''),
  // auto settings
