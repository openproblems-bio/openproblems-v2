...
thisConfig = processConfig(jsonSlurper.parseText('''{
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/common/dataset_loader/download/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.5",
...
par = {
  'url': $( if [ ! -z ${VIASH_PAR_URL+x} ]; then echo "r'${VIASH_PAR_URL//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/common/dataset_loader_download",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
