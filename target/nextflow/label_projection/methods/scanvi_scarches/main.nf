...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/label_projection/methods/scanvi_scarches/"
      }
    ],
    "test_resources" : [
      {
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/label_projection/methods/scanvi_scarches/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.3",
