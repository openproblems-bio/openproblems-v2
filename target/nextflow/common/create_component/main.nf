    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/common/create_component/"
      },
      {
        "type" : "file",
  ...
  "platforms" : [
    {
      ...
      "setup" : [
        ...
        },
        {
          "type" : "docker",
          "run" : [
            "cd /usr/bin && curl -fsSL dl.viash.io | bash"
          ]
        },
        {
          "type" : "python",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/common/create_component",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
