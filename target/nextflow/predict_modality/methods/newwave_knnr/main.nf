// newwave_knnr integration_build
// 
    ...
    "resources" : [
      {
        ...
        "path" : "script.R",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/tasks/predict_modality/methods/newwave_knnr/"
      }
    ],
    "test_resources" : [
      {
...
par <- list(
  ...
  "newwave_maxiter" = $( if [ ! -z ${VIASH_PAR_NEWWAVE_MAXITER+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_NEWWAVE_MAXITER" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
  "newwave_ngene" = $( if [ ! -z ${VIASH_PAR_NEWWAVE_NGENE+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_NEWWAVE_NGENE" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
  "newwave_ncell" = $( if [ ! -z ${VIASH_PAR_NEWWAVE_NCELL+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_NEWWAVE_NCELL" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/predict_modality/methods/newwave_knnr",
