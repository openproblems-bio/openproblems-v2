...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/dimensionality_reduction/process_dataset/"
      }
    ],
    "test_resources" : [
      {
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/dimensionality_reduction/process_dataset/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.3",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/dimensionality_reduction/process_dataset",
    "tag" : "main_build"
  },
  "label" : [
    "highmem",
