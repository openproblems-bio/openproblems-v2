...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/modality_alignment/datasets/sample_dataset/config.vsh.yaml"
      },
      {
        "type" : "file",
        "path" : "../../utils/utils.py",
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/modality_alignment/datasets/sample_dataset/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.5",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/modality_alignment/datasets_sample_dataset",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
