  ...
  "resources" : [
    {
      ...
      "path" : "script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/label_projection/data_processing/censoring/config.vsh.yaml"
    }
  ],
  "test_resources" : [
    {
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/label_projection/data_processing_censoring",
    "tag" : "main_build"
  }
}'''),
  // auto settings
