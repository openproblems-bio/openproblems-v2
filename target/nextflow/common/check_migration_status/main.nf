// check_migration_status main_build
// 
...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/common/check_migration_status/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/common/check_migration_status/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.0",
    "git_commit" : "37531e706e9df71f9b9ce023e983dfda27d43908",
...
par = {
  'git_sha': $( if [ ! -z ${VIASH_PAR_GIT_SHA+x} ]; then echo "r'${VIASH_PAR_GIT_SHA//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'comp_info': $( if [ ! -z ${VIASH_PAR_COMP_INFO+x} ]; then echo "r'${VIASH_PAR_COMP_INFO//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/common/check_migration_status",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
