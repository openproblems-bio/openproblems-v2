...
thisHelpMessage = '''download main_build
...
Options:
    --output
        ...
        example: output.h5ad
        Output h5ad file of the cleaned dataset
    ...
    --obs_celltype
        type: string
        Location of where to find the observation cell types.
    ...
    --obs_tissue
        type: string
        Location of where to find the observation tissue information.'''
