// nayve_random_celltype main_build
// 
  ...
  "resources" : [
    {
      ...
      "path" : "script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/label_projection/control_methods/nayve_random_celltype/config.vsh.yaml"
    }
  ],
  "description" : "Random Labels dummy",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test_script.py",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/label_projection/control_methods_nayve_random_celltype",
    "tag" : "main_build"
  }
}'''),
  // auto settings
