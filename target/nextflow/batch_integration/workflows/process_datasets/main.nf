...
thisConfig = processConfig(readJsonBlob('''{
  "functionality" : {
    ...
    "dependencies" : [
      ...
      },
      {
        ...
        "foundConfigPath" : "/home/runner/work/openproblems-v2/openproblems-v2/src/tasks/batch_integration/process_dataset/config.vsh.yaml",
        "configInfo" : {
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/tasks/batch_integration/workflows/process_datasets/config.vsh.yaml",
    "platform" : "nextflow",
...
include { process_dataset } from "$resourcesDir/../../../../nextflow/batch_integration/process_dataset/main.nf"
