...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "main.nf",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/label_projection/workflows/run/config.vsh.yaml"
      }
    ],
    "status" : "enabled",
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/label_projection/workflows/run/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.6",
