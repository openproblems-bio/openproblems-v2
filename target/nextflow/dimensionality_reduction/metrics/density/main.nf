...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/dimensionality_reduction/metrics/density/config.vsh.yaml"
      }
    ],
    "description" : "density preservation: correlation of local radius with the local radii in the original data space",
    "test_resources" : [
      {
        "type" : "file",
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/dimensionality_reduction/metrics/density/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.6",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/dimensionality_reduction/metrics_density",
    "tag" : "main_build"
  },
  "label" : [
    "lowmem",
