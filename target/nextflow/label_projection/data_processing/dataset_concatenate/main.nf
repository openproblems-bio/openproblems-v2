// dataset_concatenate main_build
// 
  ...
  "resources" : [
    {
      ...
      "path" : "script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/common/dataset_concatenate/config.vsh.yaml"
    }
  ],
...
par = {
  'inputs': $( if [ ! -z ${VIASH_PAR_INPUTS+x} ]; then echo "'${VIASH_PAR_INPUTS//\\'/\\\\\\'}'.split(':')"; else echo None; fi ),
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/label_projection/data_processing_dataset_concatenate",
    "tag" : "main_build"
  }
}'''),
  // auto settings
