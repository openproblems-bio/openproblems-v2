    ...
    "resources" : [
      {
        ...
        "path" : "script.R",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/common/extract_scores/config.vsh.yaml"
      }
    ],
...
par <- list(
  ...
  "column_names" = $( if [ ! -z ${VIASH_PAR_COLUMN_NAMES+x} ]; then echo -n "strsplit('"; echo -n "$VIASH_PAR_COLUMN_NAMES" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "', split = ':')[[1]]"; else echo NULL; fi ),
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/common_extract_scores",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
