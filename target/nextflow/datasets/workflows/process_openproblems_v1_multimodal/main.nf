...
thisConfig = processConfig(readJsonBlob('''{
    ...
    "resources" : [
      {
        ...
        "path" : "main.nf",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/datasets/workflows/process_openproblems_v1_multimodal/",
        "entrypoint" : "run_wf"
      }
    ],
    ...
    "dependencies" : [
      {
        ...
        "foundConfigPath" : "/home/runner/work/openproblems-v2/openproblems-v2/src/datasets/loaders/openproblems_v1_multimodal/config.vsh.yaml",
        "configInfo" : {
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/datasets/workflows/process_openproblems_v1_multimodal/config.vsh.yaml",
    "platform" : "nextflow",
...
// import dependencies
rootDir = getRootDir()
include { openproblems_v1_multimodal } from "$resourcesDir/../../../../nextflow/datasets/loaders/openproblems_v1_multimodal/main.nf"
include { log_cp } from "$resourcesDir/../../../../nextflow/datasets/normalization/log_cp/main.nf"
include { log_scran_pooling } from "$resourcesDir/../../../../nextflow/datasets/normalization/log_scran_pooling/main.nf"
include { sqrt_cp } from "$resourcesDir/../../../../nextflow/datasets/normalization/sqrt_cp/main.nf"
include { l1_sqrt } from "$resourcesDir/../../../../nextflow/datasets/normalization/l1_sqrt/main.nf"
include { subsample } from "$resourcesDir/../../../../nextflow/datasets/processors/subsample/main.nf"
include { svd } from "$resourcesDir/../../../../nextflow/datasets/processors/svd/main.nf"
include { hvg } from "$resourcesDir/../../../../nextflow/datasets/processors/hvg/main.nf"
