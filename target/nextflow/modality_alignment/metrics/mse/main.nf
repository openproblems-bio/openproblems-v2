...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "./script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/modality_alignment/metrics/mse/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/modality_alignment/metrics/mse/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.6",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/modality_alignment/metrics_mse",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
