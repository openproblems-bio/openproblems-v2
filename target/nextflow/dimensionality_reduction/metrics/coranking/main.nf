    ...
    "resources" : [
      {
        ...
        "path" : "script.R",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/dimensionality_reduction/metrics/coranking/config.vsh.yaml"
      }
    ],
    "description" : "This is a set of metrics which all use a co-ranking matrix as the basis of the metric.\n",
    "test_resources" : [
      {
        "type" : "file",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/dimensionality_reduction/metrics_coranking",
    "tag" : "main_build"
  },
  "label" : [
    "highmem",
