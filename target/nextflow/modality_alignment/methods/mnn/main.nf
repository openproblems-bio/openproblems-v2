...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "./script.R",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/modality_alignment/methods/mnn/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/modality_alignment/methods/mnn/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.6",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/modality_alignment/methods_mnn",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
