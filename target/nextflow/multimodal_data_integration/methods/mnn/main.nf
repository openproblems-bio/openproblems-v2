...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "./script.R",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/multimodal_data_integration/methods/mnn/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/multimodal_data_integration/methods/mnn/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.7",
...
par <- list(
  ...
  "n_svd" = $( if [ ! -z ${VIASH_PAR_N_SVD+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_N_SVD" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi )
)
meta <- list(
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/multimodal_data_integration/methods_mnn",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
