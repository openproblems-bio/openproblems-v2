    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/datasets/normalization/log_cp/"
      }
    ],
...
par = {
  ...
  'norm_id': $( if [ ! -z ${VIASH_PAR_NORM_ID+x} ]; then echo "r'${VIASH_PAR_NORM_ID//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
