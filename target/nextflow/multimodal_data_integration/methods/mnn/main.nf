...
thisConfig = processConfig(jsonSlurper.parseText('''{
  "functionality" : {
    "name" : "mnn",
    "namespace" : "multimodal_data_integration/methods",
    ...
    "resources" : [
      {
        ...
        "path" : "./script.R",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/tasks/multimodal_data_integration/methods/mnn/"
      }
    ],
    "test_resources" : [
      {
    ...
    "info" : {
      ...
      "description" : "Mutual Nearest Neighbors is a method for integrating multimodal single-cell data. It is based on the idea of finding mutual nearest neighbors between the two modalities. The method is described in the following paper: https://doi.org/10.1038/nbt.4091\n",
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/tasks/multimodal_data_integration/methods/mnn/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.3",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/multimodal_data_integration/methods/mnn",
