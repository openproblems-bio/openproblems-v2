...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/batch_integration/transformers/embed_to_graph/config.vsh.yaml"
      }
    ],
    "description" : "Transform an embedded integration to a graph integration",
    "info" : {
      "type" : "method",
      "pretty_name" : "Embedding to Graph"
    },
    "status" : "enabled",
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/batch_integration/transformers/embed_to_graph/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.0",
