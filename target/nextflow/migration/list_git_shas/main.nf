    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/migration/list_git_shas/"
      }
    ],
      ...
      "test_setup" : [
        {
          "type" : "docker",
          "run" : [
            "git clone https://github.com/openproblems-bio/openproblems-v2.git"
          ]
        }
      ]
    },
...
par = {
  ...
  'show_history': $( if [ ! -z ${VIASH_PAR_SHOW_HISTORY+x} ]; then echo "r'${VIASH_PAR_SHOW_HISTORY//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/migration/list_git_shas",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
