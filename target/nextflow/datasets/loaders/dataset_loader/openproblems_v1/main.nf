...
thisConfig = processConfig([
  ...
  "namespace" : "datasets/loaders/dataset_loader",
  "version" : "main_build",
  "argument_groups" : [
    {
      "name" : "Inputs",
  ...
  "resources" : [
    {
      ...
      "path" : "script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/datasets/loaders/openproblems_v1/config.vsh.yaml"
    }
  ],
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/datasets/loaders/dataset_loader_openproblems_v1",
    "tag" : "main_build"
  }
}'''),
  // auto settings
