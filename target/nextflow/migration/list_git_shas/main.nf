...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/migration/list_git_shas/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "viash_version" : "0.7.0",
    "git_commit" : "a7a59e427278bd4d74ffbf7753540933a73e4ce0",
