...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/label_projection/methods/xgboost/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/label_projection/methods/xgboost/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.7",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/label_projection/methods_xgboost",
    "tag" : "main_build"
  },
  "label" : [
    "midmem",
