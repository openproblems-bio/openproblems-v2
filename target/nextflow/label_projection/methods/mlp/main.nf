  ...
  "resources" : [
    {
      ...
      "path" : "script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/label_projection/methods/mlp/config.vsh.yaml"
    },
    {
      "type" : "file",
      "path" : "../../utils.py",
...
par = {
  ...
  'hidden_layer_sizes': $( if [ ! -z ${VIASH_PAR_HIDDEN_LAYER_SIZES+x} ]; then echo "list(map(int, '${VIASH_PAR_HIDDEN_LAYER_SIZES//\\'/\\\\\\'}'.split(':')))"; else echo None; fi ),
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/label_projection/methods_mlp",
    "tag" : "main_build"
  }
}'''),
  // auto settings
