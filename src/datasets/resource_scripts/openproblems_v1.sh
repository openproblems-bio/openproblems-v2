...
param_list:
  ...
  - id: tabula_muris_senis_droplet_lung
    ...
    dataset_description: |
      All lung cells from 10x profiles in Tabula Muris Senis, a 500k cell-atlas from 18 organs and tissues across the mouse lifespan.
    dataset_organism: mus_musculus
  ...
  - id: tnbc_wu2021
    ...
    dataset_description: |
      1535 cells from six TNBC donors by (Wu et al., 2021). This dataset includes cytokine activities, 
      inferred using a multivariate linear model with cytokine-focused signatures, as assumed true cell-cell
      communication (Dimitrov et al., 2022).
    dataset_organism: homo_sapiens
