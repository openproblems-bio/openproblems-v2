...
thisHelpMessage = '''randomize main_build

Label_projection component to preprocess pancreas data
...
Options:
    ...
    --method
        ...
        The process method to assign train/test. Options: ['batch', 'random',
'random_with_noise']

    --output
        type: file, required parameter, output
        default: output.h5ad
        Output h5ad file preprocessed'''
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/label_projection/data_processing_randomize",
    "tag" : "main_build"
  }
}"""),
  // auto settings
