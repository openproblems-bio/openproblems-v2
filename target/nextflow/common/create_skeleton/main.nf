...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/common/create_skeleton/config.vsh.yaml"
      }
    ],
    "description" : "Create a skeleton Viash component.\n\nUsage:\n```\nbin/create_skeleton --task denoising --type method --language r --name foo\nbin/create_skeleton --task denoising --type metric --language python --name bar\n```\n",
    "test_resources" : [
      {
        "type" : "python_script",
        "path" : "test.py",
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/common/create_skeleton/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.0",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/common/create_skeleton",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
