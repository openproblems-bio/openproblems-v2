...
thisConfig = processConfig(jsonSlurper.parseText('''{
  "functionality" : {
    "name" : "run_benchmark",
    "namespace" : "multimodal_data_integration/workflows",
    ...
    "resources" : [
      {
        ...
        "path" : "main.nf",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/tasks/multimodal_data_integration/workflows/run/"
      }
    ],
    "status" : "enabled",
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/tasks/multimodal_data_integration/workflows/run/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.3",
