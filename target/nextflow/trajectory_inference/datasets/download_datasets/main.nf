...
// 
// Component authors:
//  * Louise Deconinck (maintainer, author) {github: LouiseDck}
...
thisHelpMessage = '''download_datasets main_build

Download datasets to use for TI, mix of real and synthetic
...
Options:
    ...
    --input
        type: file
        default:
        Input download link for the dataset

    --output
        type: file, required parameter, output
        default: output.h5ad
        Output h5ad file containing input matrices data'''
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/trajectory_inference/datasets_download_datasets",
    "tag" : "main_build"
  }
}"""),
  // auto settings
