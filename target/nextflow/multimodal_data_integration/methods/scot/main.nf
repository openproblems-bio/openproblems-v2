...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/tasks/multimodal_data_integration/methods/scot/"
      }
    ],
    "test_resources" : [
      {
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/tasks/multimodal_data_integration/methods/scot/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.3",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/multimodal_data_integration/methods/scot",
