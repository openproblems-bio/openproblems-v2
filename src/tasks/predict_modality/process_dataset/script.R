...
## VIASH START
par <- list(
  input_rna = "resources_test/common/bmmc_cite_starter/bmmc_cite_starter.output_rna.h5ad",
  input_other_mod = "resources_test/common/bmmc_cite_starter/bmmc_cite_starter.output_adt.h5ad",
