// scarches_scanvi_all_genes main_build
// 
...
thisConfig = processConfig([
  ...
  "name" : "scarches_scanvi_all_genes",
  ...
  "resources" : [
    {
      ...
      "path" : "script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/label_projection/methods/scvi/scarches_scanvi_all_genes/config.vsh.yaml"
    },
    {
      "type" : "file",
      "path" : "../tools.py",
  ...
  "info" : {
    "type" : "baseline",
    "label" : "Scarches_scanvi_ALL_GENES"
  },
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/label_projection/methods/scvi_scarches_scanvi_all_genes",
    "tag" : "main_build"
  }
}'''),
  // auto settings
