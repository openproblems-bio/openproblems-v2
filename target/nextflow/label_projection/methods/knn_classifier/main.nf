...
thisConfig = processConfig([
  ...
  "resources" : [
    {
      ...
      "path" : "script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/label_projection/methods/knn_classifier/config.vsh.yaml"
    },
    {
      "type" : "file",
      "path" : "../../utils.py",
  ...
  "description" : "Nearest neighbor pattern classification",
  "test_resources" : [
    {
      "type" : "python_script",
