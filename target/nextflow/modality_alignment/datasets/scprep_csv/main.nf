...
thisHelpMessage = '''scprep_csv main_build

Create a modality alignment dataset from CSV using scprep.

Options:
    --id
        type: string
        default: citeseq_cbmc
        The id of the output dataset id
...
https:/www.ncbi.nlm.nih.gov/geo/download/?acc=GSE100866&format=file&file=GSE100866%5FCBMC%5F8K%5F13AB%5F10X%2DRNA%5Fumi%2Ecsv%2Egz
        Path or URL to the RNA counts as a gzipped csv file.
...
https:/www.ncbi.nlm.nih.gov/geo/download/?acc=GSE100866&format=file&file=GSE100866%5FCBMC%5F8K%5F13AB%5F10X%2DADT%5Fumi%2Ecsv%2Egz
        Path or URL to the ADT counts as a gzipped csv file.
...
extensions: '.gz', '.bz2', '.zip', or '.xz' (otherwise no decompression). If
using 'zip', the ZIP file must contain only one data file to be read in. Set to
