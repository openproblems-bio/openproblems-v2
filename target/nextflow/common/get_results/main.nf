  ...
  "functionality" : {
    ...
    "arguments" : [
      ...
      },
      {
        "type" : "file",
        "name" : "--methods_meta",
        "description" : "File containing methods metadata",
        "example" : [
          "meta_methods.json"
        ],
        "must_exist" : true,
      ...
      },
      {
        "type" : "file",
        "name" : "--metrics_meta",
        "description" : "File containing metrics metadata",
        "example" : [
          "meta_metrics.json"
        ],
        "must_exist" : true,
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/common/get_results/"
      }
    ],
...
par = {
  'input_scores': $( if [ ! -z ${VIASH_PAR_INPUT_SCORES+x} ]; then echo "r'${VIASH_PAR_INPUT_SCORES//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'input_execution': $( if [ ! -z ${VIASH_PAR_INPUT_EXECUTION+x} ]; then echo "r'${VIASH_PAR_INPUT_EXECUTION//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'methods_meta': $( if [ ! -z ${VIASH_PAR_METHODS_META+x} ]; then echo "r'${VIASH_PAR_METHODS_META//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'metrics_meta': $( if [ ! -z ${VIASH_PAR_METRICS_META+x} ]; then echo "r'${VIASH_PAR_METRICS_META//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
