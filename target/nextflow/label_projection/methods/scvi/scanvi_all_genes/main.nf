  ...
  "resources" : [
    {
      ...
      "path" : "script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/label_projection/methods/scvi/scanvi_all_genes/config.vsh.yaml"
    },
    {
      "type" : "file",
      "path" : "../tools.py",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/label_projection/methods/scvi_scanvi_all_genes",
    "tag" : "main_build"
  }
}'''),
  // auto settings
