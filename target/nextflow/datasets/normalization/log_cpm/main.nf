...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/datasets/normalization/log_cpm/"
      }
    ],
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/runner/work/openproblems-v2/openproblems-v2/target/nextflow/datasets/normalization/log_cpm",
    "viash_version" : "0.7.5",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/datasets/normalization/log_cpm",
    "tag" : "main_build"
  },
  "label" : [
    "lowmem",
