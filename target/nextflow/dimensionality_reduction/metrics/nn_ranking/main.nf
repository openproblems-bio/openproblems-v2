...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/dimensionality_reduction/metrics/nn_ranking/config.vsh.yaml"
      }
    ],
    "description" : "A set of metrics from the pyDRMetrics package.",
    "test_resources" : [
      {
        "type" : "file",
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/dimensionality_reduction/metrics/nn_ranking/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.6",
...
par = {
  'input_reduced': $( if [ ! -z ${VIASH_PAR_INPUT_REDUCED+x} ]; then echo "r'${VIASH_PAR_INPUT_REDUCED//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/dimensionality_reduction/metrics_nn_ranking",
    "tag" : "main_build"
  },
  "label" : [
    "lowmem",
