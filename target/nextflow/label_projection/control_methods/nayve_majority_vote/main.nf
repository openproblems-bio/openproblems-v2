// nayve_majority_vote main_build
// 
  ...
  "resources" : [
    {
      ...
      "path" : "script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/label_projection/control_methods/nayve_majority_vote/config.vsh.yaml"
    }
  ],
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/label_projection/control_methods_nayve_majority_vote",
    "tag" : "main_build"
  }
}'''),
  // auto settings
