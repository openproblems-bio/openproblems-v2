    ...
    "resources" : [
      {
        ...
        "path" : "script.R",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/common/get_results/config.vsh.yaml"
      }
    ],
...
par <- list(
  "input_scores" = $( if [ ! -z ${VIASH_PAR_INPUT_SCORES+x} ]; then echo -n "strsplit('"; echo -n "$VIASH_PAR_INPUT_SCORES" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "', split = ':')[[1]]"; else echo NULL; fi ),
  "input_execution" = $( if [ ! -z ${VIASH_PAR_INPUT_EXECUTION+x} ]; then echo -n "strsplit('"; echo -n "$VIASH_PAR_INPUT_EXECUTION" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "', split = ':')[[1]]"; else echo NULL; fi ),
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/common_get_execution_info",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
