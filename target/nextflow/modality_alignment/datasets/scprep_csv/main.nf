...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/modality_alignment/datasets/scprep_csv/config.vsh.yaml"
      },
      {
        "type" : "file",
        "path" : "../../utils/utils.py",
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/modality_alignment/datasets/scprep_csv/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.5",
    "git_commit" : "ac8a1c6aa5e8c254d7ab3b4cc15e7f77feaa0f0e",
...
par = {
  ...
  'input1': $( if [ ! -z ${VIASH_PAR_INPUT1+x} ]; then echo "r'${VIASH_PAR_INPUT1//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'input2': $( if [ ! -z ${VIASH_PAR_INPUT2+x} ]; then echo "r'${VIASH_PAR_INPUT2//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'compression': $( if [ ! -z ${VIASH_PAR_COMPRESSION+x} ]; then echo "r'${VIASH_PAR_COMPRESSION//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'test': $( if [ ! -z ${VIASH_PAR_TEST+x} ]; then echo "r'${VIASH_PAR_TEST//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/modality_alignment/datasets_scprep_csv",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
