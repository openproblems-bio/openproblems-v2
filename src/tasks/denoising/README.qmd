...
|`--output_test`  |`file` |(_Optional, Output_) The test data.                                                                                                                                                                        |
:::
...
|`--input_test`  |`file` |(_Optional_) The test data.             |
|`--output`      |`file` |(_Optional, Output_) The denoised data. |
:::
...
|:------------------|:------|:---------------------------------------|
|`--input_test`     |`file` |(_Optional_) The test data.             |
|`--input_denoised` |`file` |(_Optional_) The denoised data.         |
