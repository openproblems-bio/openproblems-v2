...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/batch_integration/split_dataset/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/batch_integration/split_dataset/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.0",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/batch_integration/split_dataset",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
