  ...
  "resources" : [
    {
      ...
      "path" : "script.R",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/datasets/normalization/log_scran_pooling/config.vsh.yaml"
    }
  ],
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/common/normalization_log_scran_pooling",
    "tag" : "main_build"
  }
}'''),
  // auto settings
