...
thisConfig = processConfig(jsonSlurper.parseText('''{
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/common/dataset_concatenate/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.7",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/common/data_processing_dataset_concatenate",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
