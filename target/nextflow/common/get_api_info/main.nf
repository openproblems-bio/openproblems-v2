// get_api_info integration_build
// 
...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.R",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/common/get_api_info/"
      }
    ],
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/runner/work/openproblems-v2/openproblems-v2/target/nextflow/common/get_api_info",
    "viash_version" : "0.7.5",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/common/get_api_info",
