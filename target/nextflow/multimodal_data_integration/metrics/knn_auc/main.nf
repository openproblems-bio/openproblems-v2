...
thisConfig = processConfig(jsonSlurper.parseText('''{
  "functionality" : {
    "name" : "knn_auc",
    "namespace" : "multimodal_data_integration/metrics",
    ...
    "arguments" : [
      ...
      },
      {
        ...
        "example" : [
          "resources_test/multimodal/score.h5ad"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : true,
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/tasks/multimodal_data_integration/metrics/knn_auc/"
      }
    ],
    "test_resources" : [
      {
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/tasks/multimodal_data_integration/metrics/knn_auc/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.3",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/multimodal_data_integration/metrics/knn_auc",
