...
thisConfig = processConfig(jsonSlurper.parseText('''{
  "functionality" : {
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/dimensionality_reduction/metrics/trustworthiness/config.vsh.yaml"
      }
    ],
    ...
    "info" : {
      ...
      "metrics" : [
        {
          "name" : "trustworthiness",
          "pretty_name" : "Trustworthiness at k=15",
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/dimensionality_reduction/metrics/trustworthiness/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.0",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/dimensionality_reduction/metrics/trustworthiness",
    "tag" : "main_build"
  },
  "label" : [
    "midmem",
