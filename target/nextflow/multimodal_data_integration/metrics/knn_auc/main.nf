...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/multimodal_data_integration/metrics/knn_auc/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/multimodal_data_integration/metrics/knn_auc/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.7",
...
par = {
  ...
  'n_svd': $( if [ ! -z ${VIASH_PAR_N_SVD+x} ]; then echo "int(r'${VIASH_PAR_N_SVD//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/multimodal_data_integration/metrics_knn_auc",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
