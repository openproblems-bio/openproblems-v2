...
thisConfig = processConfig([
  ...
  "resources" : [
    {
      ...
      "path" : "script.py",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/label_projection/control_methods/all_correct/config.vsh.yaml"
    }
  ],
  "description" : "Positive control method",
  "test_resources" : [
    {
      "type" : "python_script",
      "path" : "test_script.py",
  ...
  "info" : {
    ...
    "label" : "All predictions are correct"
  },
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/label_projection/control_methods_all_correct",
    "tag" : "main_build"
  }
}'''),
  // auto settings
