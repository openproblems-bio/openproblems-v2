...
param_list:
  - id: openproblems_neurips2021/bmmc_cite
    input: "$TEMP_DIR/neurips2021_bmmc_cite.h5ad"
    mod1: GEX
    mod2: ADT
  ...
  - id: openproblems_neurips2021/bmmc_multiome
    input: "$TEMP_DIR/neurips2021_bmmc_multiome.h5ad"
    mod1: GEX
    mod2: ATAC
...
src/datasets/workflows/process_openproblems_neurips2021_bmmc/main.nf
