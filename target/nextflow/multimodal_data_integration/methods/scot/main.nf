...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/multimodal_data_integration/methods/scot/config.vsh.yaml"
      },
      {
        "type" : "file",
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/multimodal_data_integration/methods/scot/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.7",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/multimodal_data_integration/methods_scot",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
