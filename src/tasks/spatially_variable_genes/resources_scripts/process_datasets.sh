...
# settings: '{"output_dataset": "$id/dataset.h5ad", "output_solution": "$id/solution.h5ad", "dataset_simulated_normalized": "$id/simulated_dataset.h5ad", "gp_k_sim": 500, "select_top_variable_genes_sim": 20, "num_reference_genes": 25}'
# rename_keys: 'input:output_dataset'
# output_state: "$id/state.yaml"
# publish_dir: s3://openproblems-data/resources/spatially_variable_genes/datasets
# HERE
...
settings: '{"output_dataset": "$id/dataset.h5ad", "output_solution": "$id/solution.h5ad", "dataset_simulated_normalized": "$id/simulated_dataset.h5ad", "gp_k_sim": 500, "select_top_variable_genes_sim": 25, "num_reference_genes": 50}'
rename_keys: 'input:output_dataset'
output_state: "$id/state.yaml"
publish_dir: s3://openproblems-data/resources/spatially_variable_genes/datasets
HERE
...
# settings: '{"output_dataset": "$id/dataset.h5ad", "output_solution": "$id/solution.h5ad", "dataset_simulated_normalized": "$id/simulated_dataset.h5ad", "gp_k_sim": 500, "select_top_variable_genes_sim": 25, "num_reference_genes": 25}'
# rename_keys: 'input:output_dataset'
# output_state: "$id/state.yaml"
# publish_dir: s3://openproblems-data/resources/spatially_variable_genes/datasets
# HERE
