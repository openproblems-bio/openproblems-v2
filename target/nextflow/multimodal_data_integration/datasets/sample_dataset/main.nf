...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/multimodal_data_integration/datasets/sample_dataset/config.vsh.yaml"
      },
      {
        "type" : "file",
        "path" : "../../utils/utils.py",
  ...
  "info" : {
    "config" : "/home/runner/work/openproblems-v2/openproblems-v2/src/multimodal_data_integration/datasets/sample_dataset/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.7",
...
par = {
  ...
  'n_genes': $( if [ ! -z ${VIASH_PAR_N_GENES+x} ]; then echo "int(r'${VIASH_PAR_N_GENES//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/multimodal_data_integration/datasets_sample_dataset",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
