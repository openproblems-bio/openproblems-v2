// random_embed_cell_jitter main_build
// 
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/tasks/batch_integration/control_methods/random_embed_cell_jitter/"
      }
    ],
    "test_resources" : [
      {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/batch_integration/control_methods/random_embed_cell_jitter",
    "tag" : "main_build"
  },
  "label" : [
    "midtime",
