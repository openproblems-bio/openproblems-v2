// check_dataset_schema integration_build
// 
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openproblems-v2/openproblems-v2/src/common/check_dataset_schema/"
      }
    ],
...
par = {
  ...
  'checks': $( if [ ! -z ${VIASH_PAR_CHECKS+x} ]; then echo "r'${VIASH_PAR_CHECKS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "r'${VIASH_PAR_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'meta': $( if [ ! -z ${VIASH_PAR_META+x} ]; then echo "r'${VIASH_PAR_META//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
